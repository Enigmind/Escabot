...
Welcome(client, {
	...
	"772194344929067019": {
		publicmsg : "Bienvenue @MEMBER ! Viens donc jouer avec nous ! Hésite pas à me solliciter si besoin (`/help` pour la liste des commandes), je réponds toujours (sauf quand j'ai la flemme).",
